...
if selected == "Customer":
    ...
    with st.expander("Interpretation", expanded=False):
        ...
        # Konten expander
        st.text("""Jumlah pelanggan berdasarkan wilayah:
    ...
    with st.expander("Saran", expanded=False):
        ...
        # Konten expander
        st.text("""- Mengembangkan Pasar di Daerah Dengan Pelanggan Yang Tinggi
        Manfaatkan potensi pasar di wilayah seperti Sao Paulo yang memiliki jumlah pelanggan tertinggi. Identifikasi segmentasi pasar yang spesifik di wilayah Sao Paulo dan kembangkan kampanye pemasaran yang relevan untuk menarik minat pelanggan untuk melakukan transaksi.
        - Penawaran Promo Khusus Daerah Dengan Pelanggan Yang Rendah:
        Tawarkan diskon khusus untuk pembelian produk tertentu kepada pelanggan di daerah dengan jumlah pelanggan rendah. Misalnya, memberikan diskon 15% untuk semua pelanggan di Guarulhos dalam jangka waktu tertentu.""")
...
if selected == "Seller":
    ...
    with st.expander("Interpretasi", expanded=False):
        ...
        # Konten expander
        st.text("""Jumlah penjual berdasarkan wilayah:
    ...
    with st.expander("Saran", expanded=False):
        ...
        Manfaatkan potensi pasar di wilayah seperti Sao Paulo yang memiliki jumlah seller tertinggi untuk menarik pembeli sebanyak - banyaknya. Memberikan promo seperti discount atau lainnya di segmentasi seller yang barangnya memiliki minat yang tinggi dari pembeli.
        - Menyelidiki Daerah Yang Memiliki Seller Yang Rendah:
        Daerah yang jumlah sellernya edikit bisa dikarenakan daerah tersebut jauh dari kebanyakan tempat pelanggan, sehingga sedikit pelanggan yang membeli dari daerah tersebut dan menyebabkan sedikitnya jumlah seller disana. Karena dapat dilihat dari jumlah customer paling banyak berada di saopaulo. Oleh karena itu mungkin bisa di pertimbangkan untuk membuat promosi seperti memberikan gratis ongkir atau sebagainya.""")
...
if selected == "Customer Segmentation":
    ...
    with st.expander("Saran", expanded=False):
        ...
        Mengurangi jumlah pelanggan dengan nilai RFM yang rendah dengan memberikan penawaran khusus, diskon, atau program loyalitas seperti membership agar pelanggan menjadi lebih tertarik untuk berbelanja dan melakukan lebih dari satu transaksi.
        - Memberikan Reward Kepada 'High Value Customer' dan 'Top Customer'
        Memberikan reward kepada pelanggan tersebut yang dapat meningkatkan 'customer experience' mereka seperti harga khusus, pelayanan yang lebih diutamakan, fasilitas eksklusif seperti fitur khusus. Sehingga pelanggan tersebut tetap menjadi pelanggan dengan statis 'High value' atau 'Top'.""")
