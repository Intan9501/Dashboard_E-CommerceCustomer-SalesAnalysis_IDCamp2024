...
if selected == "2016":
    ...
    with st.container():
        ...
        with st.expander("Saran", expanded=False):
            ...
            # Konten expander
            st.write("""Mengumpulkan data yang Lebih Komprehensif: 
                     Sebaiknya dipastikan untuk mengumpulkan data penjualan yang lebih lengkap dan komprehensif di masa mendatang. Hal ini dapat dilakukan dengan merekam setiap transaksi penjualan dengan lebih baik. Dengan data yang lengkap, maka dapat dilakukan identifikasi produk yang memiliki tingkat penjualan secara lebih akurat.\n\n\n""")
...
if selected == "2017":
    ...
    with st.container():
        ...
        with st.expander("Saran", expanded=False):
            ...
            st.text("""- Memanfaatkan Tren Pertumbuhan:
            Memanfaatkan adanya tren pertumbuhan yang baik pada tahun 2017 untuk meningkatkan penjualan di tahun-tahun berikutnya dengan mengidentifikasi faktor-faktor yang berkontribusi terhadap peningkatan penjualan pada bulan November, seperti promosi khusus, produk yang populer, atau strategi pemasaran yang efektif.
            - Analisis Bulan November:
            Meneliti dengan lebih mendalam mengapa bulan November memiliki jumlah transaksi tertinggi. Apakah ada peristiwa khusus, seperti liburan atau acara penjualan besar, yang mendorong pertumbuhan tersebut. Analisis ini dapat membantu untuk merencanakan kegiatan promosi atau penjualan yang serupa di masa depan.\n\n\n""")
